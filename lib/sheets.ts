...
function getAuth() {
    ...
    if (!email || !key) {
        throw new Error('Google service account credentials not configured in .env.local');
    }
 ...
 * Columns: Registration ID | Name | Email | Phone | Payment Screenshot | Registered At
 */
